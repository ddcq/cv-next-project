				...
				<div className="col col-d-6 col-t-6 col-m-12">
					<div className="box-item">
						...
						<div className="desc">
							...
							<div className="text">
								<p>
									Ex audire suavitate has, ei quodsi tacimates sapientem sed, pri zril ubique ut. Te
									cule tation munere noluisse. Enim torquatos&#8230;
								</p>
							</div>
						</div>
					</div>
			...
			<div className="pager">
				<nav className="navigation pagination">
					<div className="nav-links">
						...
						<button className="next page-numbers">Next</button>
					</div>
				</nav>
			</div>
		</div>
