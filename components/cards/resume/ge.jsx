...
const Ge = () => (
  <ResumeItem date="Juin 2012 - Mars 2013" name="Lead Developper" company="GE Energy">
    <Widget>
      ...
      <p>
        GE Energy est une société du groupe General Electric dont l’une des activités principales est la production d’électricité et la distribution
        d’équipements et de technologies associées. Il possède en particulier une technologie permettant d’« effacer » un appareil électrique d’un particulier,
        c’est-à-dire de le supprimer temporairement du réseau avec une contrepartie financière incitative. EDF est intéressé pour adapter cette technologie aux
        entreprises françaises. Le projet DRMS tente de prouver sa faisabilité et sa fiabilité.
      </p>
      ...
      <ul>
        ...
        <li>
          À partir du logiciel « Product » développé à Atlanta, intégration de la partie « Project » spécifique au client, déploiement de la solution finale sur
