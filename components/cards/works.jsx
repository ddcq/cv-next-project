			...
			<div className="row grid-items border-line-v">
				...
				<div className="col col-d-6 col-t-6 col-m-12 grid-item music border-line-h">
					<div className="box-item">
						...
						<div className="desc">
							<button className="name has-popup">Staircase</button>
								...
								<div className="desc">
									<div className="post-box">
										...
										<div className="blog-content">
											...
											<p>
												Forfeited you engrossed but gay sometimes explained. Another as studied
												it to evident. Merry sense given he be arise. Conduct at an replied
												removal an amongst. Remaining determine few her two cordially admitting
												old.
											</p>
											<blockquote>
												Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
												cubilia Curae; Pellentesque suscipit.
											</blockquote>
											<p>
												Tiled say decay spoil now walls meant house. My mr interest thoughts
												screened of outweigh removing. Evening society musical besides inhabit
												ye my. Lose hill well up will he over on. Increasing sufficient
											...
											<p>
												...
												meant. Death means up civil do an offer wound of.
											</p>
										</div>
					...
					<div className="box-item">
						<div className="image">
							...
							<div id="gallery-1" className="mfp-hide">
								<a href="portfolio/airfrance.png"></a>
				...
				<div className="col col-d-6 col-t-6 col-m-12 grid-item music border-line-h">
					<div className="box-item">
						...
						<div className="desc">
							<button className="name has-popup">Daylight Entrance</button>
							<div className="category">Music</div>
						</div>
					</div>
				</div>
